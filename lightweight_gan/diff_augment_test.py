...
from lightweight_gan.lightweight_gan import AugWrapper, ImageDataset, get_default_device
...
@torch.no_grad()
def DiffAugmentTest(image_size = 256, data = './data/0.jpg', types = [], batch_size = 10, rank = 0, nrow = 5, device = None):
